...
export const placeableItemSchema = catalogEntitySchema.extend({
  ...
  inGameTypeId: z.string().min(1).optional(),
  inGameTypeLabel: z.string().min(1).optional(),
  inGameRarityLabel: z.string().min(1).optional(),
  inGameQualityLabel: z.string().min(1).optional(),
